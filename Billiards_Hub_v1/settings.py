"""
Django settings for Billiards_Hub_v1 project.
...
SECRET_KEY = 'django-insecure-z+#@f8se-)&dxuo)i94i=*hnm2v*qu_3(fu#9)nt=68$ji3jzl'
...
ROOT_URLCONF = 'Billiards_Hub_v1.urls'
...
WSGI_APPLICATION = 'Billiards_Hub_v1.wsgi.application'
